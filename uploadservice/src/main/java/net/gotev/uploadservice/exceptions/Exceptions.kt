...
class UploadError(httpMethod: String, exception: Exception? = null) : UploadThrowable(message = if (exception == null) "Upload error" else exception.toString(), httpMethod = httpMethod, exception = exception)
